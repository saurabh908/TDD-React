...
describe('Carousel', () => {
  ...
  describe('with the first slide selected', () => {
    it('wraps the `slideIndex` to the max value when Prev is clicked', () => {
  ...
  describe('with the last slide selected', () => {
    it('wraps the `slideIndex` to the min value when Next is clicked', () => {
  ...
  it('renders the current slide as a CarouuselSlide', () => {
    let slideProps;
